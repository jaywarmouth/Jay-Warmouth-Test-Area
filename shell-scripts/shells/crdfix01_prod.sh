...
FILEDIR=/usr/lnk/wt/benefit-wt/Crdfix/Prodinput
OUTDIR=/usr/lnk/wt/benefit-wt/Crdfix/Prodresults
...
then
	...
	echo "Issue with CRDFIX file in benefit-wt/Crdfix/Prodinput"
	RETVAL=99
fi
