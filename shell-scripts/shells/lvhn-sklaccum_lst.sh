#!/bin/sh
#
# Program Name	: lvhn-sklaccum_lst.sh
...
usage: lvhn-sklaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="LVHNSKL_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "LVHN-SKL Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
