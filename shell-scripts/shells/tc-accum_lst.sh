#!/bin/sh
#
# Program Name	: tc-accum_lst.sh
# Description	: Moves files and creates log listing of TrialCard accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/TC"
MAIL_PROG="/bin/mail"
...
usage: tc-accum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="TC_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrialCard-Gilead Accumulator Files" > ${ELIG_LOG}/${LOG_NAME}
