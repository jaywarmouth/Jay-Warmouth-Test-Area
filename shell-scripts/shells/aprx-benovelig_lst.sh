#!/bin/ksh
#
# Program Name	: aprx-benovelig_lst.sh
# Description	: Moves files and creates log listing of APRX-Benovations eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on file sent.
# Author	: Linda S. Jefferis
# Date		: 12/08/2014
# Modifications : 12/29/2014 - add ".gpg" to PGP filename
#
#
#
# Variables Used:
...
CLIENT="ab"
FTP_DIR="/usr/lnk/wt/aprx-ftp/ToPDMI"
...
usage: aprx-benovelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXBenovations_elig_${INPUT_DATE}.dat"
	PGP_FILE="APRXBenovations_elig_${INPUT_DATE}.dat.pgp.gpg"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APPRX-Benovations Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
