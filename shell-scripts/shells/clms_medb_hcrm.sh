#!/bin/sh
#
# Program Name	: clms_medb_hcrm.sh
...
usage: clms_medb_hcrm.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="BiWeeklyclms-MEDBHCRM-${PE_DATE}.txt"
}
...
transfer_file()
{
	...
	then
	   ...
	   echo -e "The MedBen data file for period ending ${PE_DATE}, has been uploaded.\n\nRecord Count = ${REC_CNT}" | ${MAIL_PROG} -s "MEDB-HCRM File Notification" -c ${MAIL_CC} ${MAIL_TO}
	else
