#!/bin/ksh
#
# Program Name	: pabc-ebsaccum_lst.sh
# Description	: Moves files and creates log listing of PABC-EBS eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/PABCEBS/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: pabc-ebsaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="PABCEBS_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "PABC-EBS Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
