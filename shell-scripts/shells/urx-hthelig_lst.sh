#!/bin/sh
#
# Program Name	: urx-hthelig_lst.sh
# Description	: Moves files and creates log listing of URX-HTH eligibility file.
...
FILE_PATH="URX/HTH/INBOUND/Elig"
...
usage: urx-hthelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="hthurx_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "URX-HTH Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
