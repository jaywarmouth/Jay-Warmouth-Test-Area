#!/bin/sh
#
# Program Name	: epls-hmaelig_lst.sh
# Description	: Moves files and creates log listing of EPLS-HMA eligibility file.
...
FILE_PATH="EVO/VRDG/INBOUND/Elig"
...
usage: epls-hmaelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EPLSHMA_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EPLS-HMA (Sys0213) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
