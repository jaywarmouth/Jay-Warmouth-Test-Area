#!/bin/ksh
#
# Program Name	: trrx-1212_lst.sh
# Description	: Moves files and creates log listing of TrueRx-1212 eligibility file.
...
CLIENT="sg"
FTP_DIR="/usr/lnk/wt/cotd-ftp/ToPDMI"
...
usage: trrx-1212_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="trx1212_elig_${INPUT_DATE}.txt"
	PGP_FILE="trx1212_elig_${INPUT_DATE}.txt.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-1212 Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
