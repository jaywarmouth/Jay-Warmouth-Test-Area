#!/bin/sh
#
# Program Name	: evo-bsenelig_lst.sh
...
FILE_PATH="EVO/BSEN/INBOUND/Elig"
...
usage: evo-bsenelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOBSEN_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-BSEN (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
