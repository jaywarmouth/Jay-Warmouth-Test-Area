#!/bin/ksh
#
# Program Name	: tsc-healthsmart_lst.sh
# Description	: Moves files and creates log listing of TrueScripts HealthSmart eligibility file.
...
usage: tsc-healthsmart_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="TSCHEALTHSMART_ELIG_${INPUT_DATE}.DAT"
	PGP_FILE="TSCHEALTHSMART_ELIG_${INPUT_DATE}.DAT.PGP"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueScripts-HealthSmart(sys163) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
