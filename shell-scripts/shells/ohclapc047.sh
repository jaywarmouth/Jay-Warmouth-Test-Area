#!/bin/ksh
#
# Program Name	: ohclapc047.sh
# Description	: Aultcare-MEDD Twice-daily report file
# Author	: Linda S. Jefferis
# Date		: 05/23/2014
# Modifications : 08/13/2014 - changes based on TT #10923-52
...
FG4CSF=/usr/lnk/tmp/clapc047.csv ;export FG4CSF
FG4BATCH=Y              ;export FG4BATCH
./runfg4  OHCLAPC047 -k -a 'TIO=_./;;'
