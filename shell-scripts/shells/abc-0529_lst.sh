#!/bin/ksh
#
# Program Name	: abc-0529_lst.sh
# Description	: Creates log listing of ABC/Stafford Development eligibility file.
...
usage: abc-0529_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="stafford${INPUT_DATE}.pdm.pgp"
	ELIG_FILE="stafford${INPUT_DATE}.pdm"
}
...
create_listing()
{
	LOG_NAME=abc-0529${DATE}.log
        cd ${ELIG_DIR}
        echo "ABC Managed Care/Stafford(spo0529) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
