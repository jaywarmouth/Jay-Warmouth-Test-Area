#!/bin/sh
#
# Program Name	: clms_hcm.sh
# Description	: Procedure to setup clmrt01 claims file for PAF-HCM (sys0226)
...
set_filenames()
{
        ...
        PE_DATE=${YR}${MO}${DAY}
	CLM_FILE="Refreshclms-HCM-${PE_DATE}.txt"
}
