#!/bin/sh
#
# Program Name	: clms_trx_medb_claim111d0.sh
# Description	: Procedure to setup and transfer claims file for sponsor 2204 and upload to MedBen
...
usage: clms_trx_medb_claim111d0.sh -p <p/e date>
...
echo "-=> file copied..."
echo "The weekly claim111d0 TRX claims file for p/e ${DATE} is now available." | ${MAIL_PROG} -s "WEEKLY FILE NOTIFICATION" -c ${MAIL_CC} ${MAIL_TO}
