...
# Description	: Run daemon to recieve test claims via TCP
...
# Main routine
#
SCRIPT_NAME="tcpfileclaim_test"
CONFIG_FILE="/usr/local/pub/realtime_tcpfileclaim_test.cfg"
PORT="10083"
RUN_AS="c04tst"
...
'start')
	...
	mkdir -p /tmp/lines/realtime_test
	chown c04tst /tmp/lines/realtime_test
	chmod 750 /tmp/lines/realtime_test
