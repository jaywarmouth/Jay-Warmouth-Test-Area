#!/bin/sh
#
# Program Name	: clms_tsc_meritain.sh
...
TMP_LOC="/tmp"
DEST_LOC=/usr/lnk/wt/oper-wt/sftpexport/MRTN
TAPE_FILE="???CL111D0-W-MERI"
LOG_FILE="???CL111D0-W-MERITEXT"
...
usage: clms_tsc_meritain.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="Weeklyclms-TSCMeritain-${PE_DATE}.txt"
...
copy_files()
{
	...
	then
	   ...
	   cat ${FILE_LOC}/${LOG_FILE} | ${MAIL_PROG} -s "TrueScripts-Meritain Weekly Claims File Notification" -c ${MAIL_CC} ${MAIL_TO}
	else
