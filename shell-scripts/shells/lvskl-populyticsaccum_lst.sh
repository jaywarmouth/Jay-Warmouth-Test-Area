#!/bin/sh
#
# Program Name	: lvskl-populyticsaccum_lst.sh
# Description	: Moves files and creates log listing of LVHN-SKL (sys0194) accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/LVHNSKL/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: lvskl-populyticsaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="LVSKLPopulytics_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "LV-SKLPopulytics Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
