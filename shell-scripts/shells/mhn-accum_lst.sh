#!/bin/ksh
#
# Program Name	: mhn-accum_lst.sh
# Description	: Creates log listing of MHN Accumulator file.
...
create_listing()
{
	LOG_NAME=mhn-accum${DATE}.log
        cd ${ELIG_DIR}
        echo "MHN - 68/451 Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
