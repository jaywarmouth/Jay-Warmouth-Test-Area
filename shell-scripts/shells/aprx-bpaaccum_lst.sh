#!/bin/sh
#
# Program Name	: aprx-bpaaccum_lst.sh
# Description	: Moves files and creates log listing of APRX-BPA accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/APRXBPA/ToPDMI"
...
usage: aprx-bpaaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="APRXBPA_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-BPA Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
