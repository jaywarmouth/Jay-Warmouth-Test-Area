#!/bin/sh
#
# Program Name	: rxeob_genpc002.sh
# Description	: Extract of GPI5001-6001 data for RXEOB
...
date
echo "      --> Extracting ${EXTRACT_FILE} - ohgenpc002.cs"
${FLEX}/ohgenpc002.cs
date
