#!/bin/ksh
#
# Program Name	: clms_lash_lnov.sh
# Description	: Procedure to setup claims file for LASH-NOVARTIS
...
usage: clms_lash_lnov.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="lnov-bimon${MON}${DAY}.txt"
}
