#!/bin/ksh
#
# Program Name	: zip_rebate15.sh
# Description	: Prepare Rebate15 file for sending.
...
TAPE_FILE="RB15-?-QCP"				# Original file
LOG_FILE="readme.txt"
...
usage: zip_rebate15.sh -p <m/e prefix> -c <record count>
...
set_filenames()
{
      ZIP_FILE=rebate-data.zip      # Zip file name
      TXT_FILE=rebate-data.txt
}
...
rename_files()
{
   ...
   then
     ...
     echo "-*> REBATE15 claims file does not exist..."
   fi
