#!/bin/ksh
#
# Program Name	: aprx-cdbelig_lst.sh
# Description	: Moves files and creates log listing of APRX-CDB eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/APRXCDB/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: aprx-cdbelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXCDB_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-CDB Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
