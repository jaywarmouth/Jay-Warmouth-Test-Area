#!/bin/ksh
#
# Program Name	: claim60.sh
# Description   : Suspended Claims Report by Sponser 
...
# Submit claim60 program
submit_claim60()
{
   if [ ${SKIP_SORT} = 1 ]
     then
        runcobol ${OBJ_DIR}/claim60 -s 1
     else
        runcobol ${OBJ_DIR}/claim60 -s 0
   fi
}
...
echo Suspended Claims Report by Sponser
date
echo
