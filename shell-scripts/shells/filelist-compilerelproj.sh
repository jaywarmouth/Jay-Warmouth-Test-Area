...
{
	echo "USAGE:"
	echo "filelist-compilerelproj.sh filename cobdir"
...
RPT_FILE=/usr/lnk/rpt/mass-compilerelproj.txt
...
do
	...
	echo $nfile
	/usr/lnk/shell/rmcompileopsgit-relproj.sh -a $nfile $cobdir >> ${RPT_FILE} 2>&1
done
date >> ${RPT_FILE}
echo " "
