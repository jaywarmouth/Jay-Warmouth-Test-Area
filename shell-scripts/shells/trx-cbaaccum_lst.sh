#!/bin/sh
#
# Program Name	: trx-cbaaccum_lst.sh
# Description	: Moves files and creates log listing of TRX-CBA accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/TRXCBA/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: trx-cbaaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="TRXCBA_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-CBA Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
