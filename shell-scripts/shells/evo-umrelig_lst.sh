#!/bin/sh
#
# Program Name	: evo-umrelig_lst.sh
# Description	: Moves files and creates log listing of EVO-UMR eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on file sent.
# Author	: Linda Jefferis
#		:
# Modifications : 08/26/2025 - Added coding for s3 file locations (DME)
#
#
# Variables Used:
INPUT_DATE="null"
...
FILE_PATH="EVO/UMR/INBOUND/Elig"
...
usage: evo-umrelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOUMR_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-UMR (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
