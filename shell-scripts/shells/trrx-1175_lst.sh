...
usage: abc-1175_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="PDMIDraper834out_${INPUT_DATE}_??????.dat"
	PGP_FILE="PDMIDraper834out_${INPUT_DATE}_??????.dat.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX - Draper (SPO1175) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
