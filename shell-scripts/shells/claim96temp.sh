...
#		: 08/28/2014 - TT #11487-11 restack enhancement change
#
# Variables Used:
...
restack_setup()
{
	...
	AUDIT20MAS=${AUDIT_PATH}/${FNAME[0]}${DATE}; export AUDIT20MAS
...
submit_claim96()
{
       case ${AUDIT} in
		...
		AUDIT20MAS=${AUDIT_PATH}/${FNAME[14]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}
		...
		AUDIT20MAS=${AUDIT_PATH}/${FNAME[15]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}
		...
		AUDIT20MAS=${AUDIT_PATH}/${FNAME[16]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}
		...
		AUDIT20MAS=${AUDIT_PATH}/${FNAME[17]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}
		...
		AUDIT20MAS=${AUDIT_PATH}/${FNAME[10]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}

		AUDIT20MAS=${AUDIT_PATH}/${FNAME[11]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}

		AUDIT20MAS=${AUDIT_PATH}/${FNAME[12]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}

		AUDIT20MAS=${AUDIT_PATH}/${FNAME[13]}${DATE}
		export AUDIT20MAS
		echo -e "\nAUDIT20MAS=$AUDIT20MAS"
		date
		runcobol ${OBJ_DIR}/claim96 -s ${SW}
	    ...
	    echo -e "\nAUDIT20MAS=$AUDIT20MAS"
	    date
            runcobol ${OBJ_DIR}/claim96 -s 00010000 
            ;;
        esac
}
