#!/bin/ksh
#
# Program Name	: 340b_HWESTelig_lst.sh
#		  Command Line Arguments:
#		  -d <yyyymmdd> - date on elig. file sent
# Description	: Moves and creates listing of the 340b-Health West (sys0134/spo03670) eligibility file
...
CLIENT="hi"
INPUT_DATE="null"
REMOTE_DIR="/usr/lnk/wt/healthwestinc-ftps/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: 340b-HWESTelig_lst.sh -d <yyyymmdd>
...
set_filename()
{
	ELIG_FILE="340BHWEST_elig_${INPUT_DATE}.csv"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "340B-HealthWest (134/3670) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
