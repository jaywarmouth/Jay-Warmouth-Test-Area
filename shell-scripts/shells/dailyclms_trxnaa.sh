#!/bin/ksh
#
# Program Name	: dailyclms_trxnaa.sh
...
"
EQUAL="="
FILE_LOC="/usr/lnk/wt/oper-wt/claimsdetail/TRXNAA"
TMP_LOC="/tmp"
...
set_filenames()
{
	CLM_FILE="Dailyclms-TRXNAA-${DATE}.txt"
	INPUT_FILE="TRRXVendorNAAClaimsData_${DATE}.txt"
}
