#!/bin/sh
#
# Program Name	: aprx-ahaelig_lst.sh
# Description	: Moves files and creates log listing of APRX-EBSO eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/APRXEBSO/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: aprx-ahaelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXEBSO_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-EBSO Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
