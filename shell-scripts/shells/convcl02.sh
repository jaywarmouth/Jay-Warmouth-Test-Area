#!/bin/ksh
#
# Program Name	: convcl02.sh
# Description	: Updates Y2K audit files to NON-Y2K CLAIM00MAS files.
...
usage: convcl02.sh [-a all|dir|env|ndc|dmr|clm] -d [yymmdd] -p [<path>]
