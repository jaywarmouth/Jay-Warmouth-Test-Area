#!/bin/sh
#
# Program Name	: evo-cgielig_lst.sh
# Description	: Moves files and creates log listing of EVO-CGI eligibility file.
...
FILE_PATH="EVO/CGI/INBOUND/Elig"
...
usage: evo-cgielig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOCGI_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-CGI (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
