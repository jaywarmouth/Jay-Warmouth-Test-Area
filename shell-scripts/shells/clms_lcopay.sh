#!/bin/sh
#
# Program Name	: clms_lcopay.sh
# Description	: Procedure to setup claims file for Lash-Copay (120)
...
#		: 12/09/2022 - copy of file to FVF (Cherwell #53732)
#
# Variables Used:
FILE_LOC="/usr/lnk/tapes"
TMP_LOC="/tmp"
DEST_LOC=/usr/lnk/wt/oper-wt/sftpexport/LASH/FromPDMI
DEST2_LOC=/usr/lnk/wt/fvf-sftp/INVOICES
TAPE_FILE="???CL111D0-T-LCOP"
...
usage: clms_lcopay.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="Refreshclms-LCOP-${PE_DATE2}.txt"
	CLM_FILE_OLD="LCOPAY_BIMON_${PE_DATE}.txt"
}
...
rename_files()
{
	...
	then
	  ...
	  cp ${FILE_LOC}/${TAPE_FILE} ${DEST2_LOC}/${CLM_FILE}
          if test $? -ne 0
            then
