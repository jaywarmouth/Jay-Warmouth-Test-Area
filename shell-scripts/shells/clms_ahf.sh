#!/bin/ksh
#
# Program Name	: clms_ahf.sh
# Description	: Procedure to setup claims file for Aultcare (48,53,?55)
...
TMP_LOC="/tmp"
TAPE_FILE="???CL111D0-X-AHF"
LOG_FILE="???CL111D0-X-AHFTEXT"
...
set_filenames()
{
	CLM_FILE="refreshAHFclms-${PE_DATE}.txt"
}
