...
RMPATH="/usr/lnk/COBOL_GIT/CBL_AWS_EXTRACT:/usr/lnk/COBOL_GIT/NEWCPY:/usr/lnk/COBOL_GIT/DES:/var/www/html/xbis/common:/usr/rmcobol"
...
RMPATH="/usr/lnk/COBOL_GIT/CBL_AWS_EXTRACT:/usr/lnk/COBOL_GIT/CPY:/usr/lnk/COBOL_GIT/DES:/var/www/html/xbis/common:/usr/rmcobol"
...
if [ ! -d "/usr/lnk/git/Projrmcob/$cobdir" ]
then
        mkdir -m 775 /usr/lnk/git/Projrmcob/$cobdir
fi

COB_DIR=/usr/lnk/git/Projrmcob/$cobdir
