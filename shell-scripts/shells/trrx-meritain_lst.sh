#!/bin/ksh
#
# Program Name	: trrx-meritain_lst.sh
# Description	: Creates log listing of TRRX eligibility file sent from Meritain.
...
#		: 01/06/2016 - update FTP_DIR to oper-wt/elig/TRXMRTN. (TT:14602-5; DME)
#		: 01/06/2016 - Changes benefits@pdmi.com to elig_accum@pdmi.com (TT:13915-17; DME)
# Variables Used:
...
CLIENT="mt"
FTP_DIR="/usr/lnk/wt/oper-wt/elig/TRXMRTN"
...
usage: trrx-meritain_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="TRXPDMI_elig_${INPUT_DATE}.txt.pgp"
	ELIG_FILE="TRXPDMI_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=${CLIENT}e-${DATE}.log
        cd ${ELIG_DIR}
        echo "TRRX-Meritain Sponsors Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
