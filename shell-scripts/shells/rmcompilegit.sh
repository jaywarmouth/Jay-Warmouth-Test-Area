...
flagfile="$HOME/cobol_git/CTYPE/COBOL Compile Type.csv"
...
#RMPATH="`pwd`:~/cobol_git/CBL_BATCH:~/cobol_git/NEWCPY:~/cobol_git/DES:/var/www/html/xbis/common:/usr/rmcobol"
...
#RMPATH="`pwd`:~/cobol_git/CBL_BATCH:~/cobol_git/CPY:~/cobol_git/DES:/var/www/html/xbis/common:/usr/rmcobol"
...
rmcobol $sourcename O=$COB_DIR L=$LST_DIR Y
retval="$?"
