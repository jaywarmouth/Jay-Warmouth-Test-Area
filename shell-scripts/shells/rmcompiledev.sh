...
sourcename=$1
Project=$2
RMPATH=/media/cobol/users/$WUSER/workspace/$Project/source:/media/cobol/users/$WUSER/workspace/$Project/cpy:/media/cobol/users/$WUSER/workspace/$Project/des:/media/cobol/ShadowDevelopment/CPY:/media/cobol/ShadowDevelopment/DES:/var/www/html/xbis/common:/usr/rmcobol
export RMPATH
