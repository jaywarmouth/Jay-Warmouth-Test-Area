#!/bin/ksh
#
# Program Name	: schn-baselig_lst.sh
# Description	: Moves files and creates log listing of SchnucksPBM-BAS eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on file sent.
# Author	: Linda S. Jefferis
# Date		: 12/05/2014
# Modifications : 12/22/2014 - Change ".pgp" suffix to ".asc"
#
#
#
# Variables Used:
...
CLIENT="ib"
FTP_DIR="/usr/lnk/wt/bas-ftp/Schnucks/ToPDMI"
...
usage: schn-baselig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="SCHNBAS_elig_${INPUT_DATE}.txt"
	PGP_FILE="SCHNBAS_elig_${INPUT_DATE}.txt.asc"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "SchnucksPBM-BAS Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
