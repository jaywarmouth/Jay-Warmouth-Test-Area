#!/bin/ksh
#
# Program Name	: dailyclms_trxgpa.sh
# Description	: Procedure to upload daily claims file for TrueRx (130)
...
"
EQUAL="="
FILE_LOC="/usr/lnk/wt/oper-wt/claimsdetail/TRXGPA"
TMP_LOC="/tmp"
...
set_filenames()
{
	CLM_FILE="Dailyclms-TRXGPA-${DATE}.txt"
	INPUT_FILE="TRRXSponsor1417NucaraClaimsData_${DATE}.txt"
}
