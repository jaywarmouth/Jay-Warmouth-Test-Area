#!/bin/sh
#
# Program Name	: aprx-jpfaccum_lst.sh
# Description	: Moves files and creates log listing of APRX-JPF accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/APRXJPF/ToPDMI"
...
usage: aprx-jpfaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="APRXJPF_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-JPF Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
