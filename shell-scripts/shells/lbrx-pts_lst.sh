#!/bin/ksh
#
# Program Name	: lbrx-pts_lst.sh
#		  Command Line Arguments:
#		  -d <ccyymmdd> - date on elig. file sent
# Description	: Moves and creates listing of the sys0174/spo1573 eligibility file
...
CLIENT="pt"
INPUT_DATE="null"
REMOTE_DIR="/usr/lnk/wt/pst-wt/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: lbrx-pts_lst.sh -d <ccyymmdd>
...
set_filename()
{
        ELIG_FILE="PTSMN_834_${INPUT_DATE}"
}
...
create_listing()
{
        LOG_NAME=pte-${DATE}.log
        cd ${ELIG_DIR}
        echo "Pipes Trades (sys0174-spo1573) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
