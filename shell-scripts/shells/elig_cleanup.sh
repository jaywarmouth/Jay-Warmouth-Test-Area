...
cleanup ()
{
   ...
   case ${ELIG_TYPE} in
	...
	then
		...
		rm -f ${ELIG_DIR}/${CLIENT}g${DATE}.lin
		mv ${ELIG_OUT}/${CLIENT}g${DATE} ${ELIG_OUT}/sys${SYS}
	fi
	 ;;
      "2")
	 mv ${ELIG_OUT}/${CLIENT}e${DATE}-X12 ${ELIG_OUT}/sys${SYS}
	 rm -f ${ELIG_DIR}/${CLIENT}e${DATE}-X12
	 ;;
      "3" | "8")
	 mv ${ELIG_OUT}/${CLIENT}e${DATE}-XLS ${ELIG_OUT}/sys${SYS}
	 rm -f ${ELIG_DIR}/${CLIENT}e${DATE}-XLS
	 ;;
   esac
}
