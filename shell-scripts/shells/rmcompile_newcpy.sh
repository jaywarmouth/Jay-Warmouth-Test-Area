...
#
# Variables :
RMPATH=/media/cobol/ShadowProduction/CPY/NEWCPY:/media/cobol/ShadowProduction/CBL:/media/cobol/ShadowProduction/DES:/var/www/html/xbis/common:/usr/rmcobol
export RMPATH
COB_DIR=/usr/lnk/scm/rmcob
SRC=".cbl"
