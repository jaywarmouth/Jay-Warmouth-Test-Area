#!/bin/ksh
#
# Program Name	: claim05.sh
# Description   : Direct Submittal Checks 
...
# Submit claim05 program
submit_claim05()
{
      runcobol ${OBJ_DIR}/claim05 -s ${SKIP_SORT}
}
