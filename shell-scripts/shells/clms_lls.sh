#!/bin/sh
#
# Program Name	: clms_lls.sh
# Description	: Procedure to setup clmrt01 claims file for PAF-LLS (sys0185)
...
set_filenames()
{
        ...
        PE_DATE=${YR}${MO}${DAY}
	CLM_FILE="Refreshclms-LLS-${PE_DATE}.txt"
}
