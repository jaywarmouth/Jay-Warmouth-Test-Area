#!/bin/ksh
#
# Program Name	: trrx-bas_lst.sh
# Description	: Moves files and creates log listing of TrueRx-BAS eligibility file.
...
usage: trrx-bas_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="BAS-TRUE-${INPUT_DATE}.txt"
	PGP_FILE="BAS-TRUE-${INPUT_DATE}.txt.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-BAS(1135/1136) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
