...
usage: claim96conv.sh [-a all|dir|16|40|dmr|clm] -d [yymmdd|yymmdd.<sys-name>] -p [<path>] -u [########]
...
submit_claim96conv()
{
       case ${AUDIT} in
	    ...
	    echo "AUDIT20MAS=$AUDIT20MAS"
            runcobol ${OBJ_DIR}/claim96conv -s ${SW} 
...
CLLOC00MAS=/usr/lnk/d0/CLLOC00MAS
   export CLLOC00MAS

CLAIM00MAS=/usr/clm/d0/CLAIM00MAS
   export CLAIM00MAS

REVER00MAS=/usr/clm/d0/REVER00MAS
   export REVER00MAS

CLAIM00OLD=/usr/lnk/d0/CLAIM512MAS
   export CLAIM00OLD

REVER00OLD=/usr/lnk/d0/REVER512MAS
  export REVER00OLD
