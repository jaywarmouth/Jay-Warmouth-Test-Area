...
set_filenames()
{
	ELIG_FILE="NGS_23000_${INPUT_DATE}"
	PGP_FILE="NGS_23000_${INPUT_DATE}.pgp"
}
...
move_files()
{
        ...
        mv ${ELIG_DIR}/${ELIG_FILE} ${ELIG_DIR}/cte${DATE}-X12
        cp ${ELIG_DIR}/cte${DATE}-X12 ${ELIG_ARCH}
}
...
create_listing()
{
        LOG_NAME=cte-spo0497${DATE}.log
        cd ${ELIG_DIR}
        echo "ScriptSense-Capital Tire/SPO0497 Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
        echo "------------------------------------------------------" >> ${ELIG_LOG}/${LOG_NAME}
        echo "" >> ${ELIG_LOG}/${LOG_NAME}
        ls -l cte${DATE}-X12 >> ${ELIG_LOG}/${LOG_NAME}
