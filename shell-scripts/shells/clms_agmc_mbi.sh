#!/bin/sh
#
# Program Name	: clms_agmc_mbi.sh
# Description	: Procedure to setup claims file for AGMC/MBI (sys0052)
#		  Command Line Arguments:
#		  -p <mmddccyy>  P/E date
# Author	: Linda S. Jefferis
# Date		: 02/23/2007
# Modifications : 02/27/2007 - Put in check for null DATE  (LSJ)
#		: 07/09/2007 - changed output name from pdm to agm  (LSJ)
#
# Variables Used:
...
usage: clms_agmc_mbi.sh -p <p/e date>
