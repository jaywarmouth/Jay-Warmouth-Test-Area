...
# Date		: 08/30/2007
# Modifications : Switched from "hw" to "iw", so made new script
#
# Variables Used:
...
set_filenames()
{
	ELIG_FILE="NGS_23001_${INPUT_DATE}"
	PGP_FILE="NGS_23001_${INPUT_DATE}.pgp"
}
...
create_listing()
{
        LOG_NAME=ss-iw-${DATE}.log
        cd ${ELIG_DIR}
        echo "ScriptSense-IW Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
