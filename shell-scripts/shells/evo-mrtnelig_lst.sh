...
FILE_PATH="EVO/MRTN/INBOUND/Elig"
...
usage: evo-mrtnelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOMRTN_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-MRTN (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
