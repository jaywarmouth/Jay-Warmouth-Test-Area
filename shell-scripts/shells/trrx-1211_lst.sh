#!/bin/ksh
#
# Program Name	: trrx-1211_lst.sh
# Description	: Moves files and creates log listing of TrueRx-1211 eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd_hhmmss> - date on file sent.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig"
REMOTE_SYS="husk"
...
usage: trrx-1211_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="trx1211_elig${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-1211 Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
