#!/bin/sh
#
# Program Name	: agmc-cobra_lst.sh
# Description	: Prepares eligibility file sent from Ceridian
#		  Select groups under sys0052
...
FTP_DIR="/usr/lnk/wt/cbs-ftp/ToPDMI"
...
usage: agmc-cobra_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="AGMC_Cobra_${INPUT_DATE}"
	PGP_FILE="AGMC_Cobra_${INPUT_DATE}.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "AGMC-Cobra Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
