#!/bin/ksh
#
# Program Name	: abc-0553_lst.sh
# Description	: Creates log listing of ABC/Trinity(553) eligibility file.
...
usage: abc-0553_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="CLAIM${INPUT_DATE}_TIS_PDM.txt.pgp"
	ELIG_FILE="CLAIM${INPUT_DATE}_TIS_PDM.txt"
}
...
create_listing()
{
	LOG_NAME=abc-0553${DATE}.log
        cd ${ELIG_DIR}
        echo "ABC Managed Care/Trinity(spo0553) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
