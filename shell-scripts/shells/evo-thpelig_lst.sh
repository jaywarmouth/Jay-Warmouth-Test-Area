#!/bin/sh
#
# Program Name	: evo-thpelig_lst.sh
# Description	: Moves files and creates log listing of EVO-THP eligibility file.
...
FILE_PATH="EVO/THP/INBOUND/Elig"
...
set_filename()
{
	ELIG_FILE="EVOTHP_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-THP (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
