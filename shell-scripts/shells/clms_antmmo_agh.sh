#!/bin/ksh
#
# Program Name	: clms_antmmo_agh.sh
# Description	: Procedure to setup claims file for sys52 to send to ANTMMO
#		  Command Line Arguments:
#		  -p <mmccyy>  M/E date
# Author	: Linda S. Jefferis
# Date		: 09/26/2008
# Modifications : 02/28/2012 - Changed to D0 file names 
#
# Variables Used:
...
usage: clms_antmmo_agh.sh -p <m/e date>
...
set_filenames()
{
	CLM_FILE="antmmo_agh${PE_DATE}.txt"
	ZIP_FILE="antmmo_agh${PE_DATE}.zip"
	NEW_LOG="totals.txt"
}
