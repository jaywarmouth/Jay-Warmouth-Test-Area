...
# Author	: James Masluk      
# Date		: 11/28/00
# Modifications : 05/10/2006 - Medicare D changes  (LSJ)
#		: 05/15/2006 - Added alternate MANDE00MAS-MEDD file when -d option is set.
#		: 10/31/2007 - Removed MANDE00MAS-MEDD alternate file  (LSJ)
#
# Variables Used:
...
submit_rebate10()
{
  runcobol ${OBJ_DIR}/rebate10 -s ${SKIP_SORT}${PLAN_LEVEL}${CONTRACT_LEVEL}${MED_D} -a ${SYS}${MAN}'          ' 
}
#
# Main routine
#
