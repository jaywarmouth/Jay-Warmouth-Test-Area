#!/bin/sh
#
# Program Name	: trx-htgeelig_lst.sh
...
#		: 02/19/2016 - fix filenaming. changing from TRXHGTE to TRXHTGE
#
# Variables Used:
...
usage: trx-htgeelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="TRXHTGE_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-Heritage(sys130) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
