#!/bin/ksh
#
# Program Name	: appro-cyp-1193_lst.sh
# Description	: Creates log listing of ApproRx eligibility file sent from Cypress Benefit.
...
usage: appro-cyp-1193_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="cyp_appro_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=${CLIENT}e-${DATE}.log
        cd ${ELIG_DIR}
        echo "ApproRx-C&K MKTS (1193) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
