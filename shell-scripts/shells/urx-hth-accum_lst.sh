#!/bin/sh
#
# Program Name	: urx-hth-accum_lst.sh
# Description	: Moves files and creates log listing of URX/HTH accum file.
#                 Command Line Arguments:
#                 -d <ccyymmddhhmmss> - date/time on file sent.
...
usage: urx-hth-accum_lst.sh [-d <ccyymmddhhmmss>]
...
set_filename()
{
	ACCUM_FILE="URXAHA_${INPUT_DATE}.TXT"
}
