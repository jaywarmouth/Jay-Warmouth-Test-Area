#!/bin/sh
#
# Program Name	: lbrx-hnaselig_lst.sh
# Description	: Moves files and creates log listing of LBRX-ISSI eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/LBRXISSI/ToPDMI"
REMOTE_SYS="husk"
...
usage: lbrx-issielig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="LBRXISSI_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "LBRX-ISSI Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
