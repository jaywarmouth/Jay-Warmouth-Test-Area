#!/bin/sh
#
# Program Name	: abc-1048_lst.sh
# Description	: Prepares Granville eligibility file sent from UHC for Benefits and processing
...
usage: abc-1048_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="PDMIGranville834out_${INPUT_DATE}_??????.dat"
	PGP_FILE="PDMIGranville834out_${INPUT_DATE}_??????.dat.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "ABC - Granville (SPO1048) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
