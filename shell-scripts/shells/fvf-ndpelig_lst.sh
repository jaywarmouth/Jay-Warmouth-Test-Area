#!/bin/sh
#
# Program Name	: fvf-ndpelig_lst.sh
# Description	: Moves files and creates log listing of FVF-NDP eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/FVFNDP/ToPDMI"
REMOTE_SYS="husk"
...
usage: fvf-ndpelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="FVFNDP_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "FVF-NDP Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
