#!/bin/sh
#
# Program Name	: clms_0361_claim111d0.sh
...
usage: clms_0361_claim111d0.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="Refreshclms_GHC111d0_${DATE}.txt"
}
...
echo "-=> file copied..."
echo "The claim111d0 QCP-Genesis claims file for p/e ${DATE} is now available." | ${MAIL_PROG} -s "FILE NOTIFICATION" -c ${MAIL_CC} ${MAIL_TO}
