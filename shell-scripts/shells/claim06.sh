#!/bin/ksh
#
# Program Name	: claim06.sh
# Description   : Pharmacy Checks 
...
#		: 11/09/2004 - Changes for new type runs  (LSJ)
...
# Submit claim06 program
submit_claim06()
{
	runcobol ${OBJ_DIR}/claim06 -s ${SKIP_SORT}
}
