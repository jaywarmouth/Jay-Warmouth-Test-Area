#!/bin/ksh
#
# Program Name	: trx-healthsmartelig_lst.sh
# Description	: Moves files and creates log listing of TrueRx HealthSmart eligibility file.
...
usage: trx-healthsmartelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="TRXHEALTHSMART_ELIG_${INPUT_DATE}.DAT"
	PGP_FILE="TRXHEALTHSMART_ELIG_${INPUT_DATE}.DAT.PGP"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-HealthSmart(sys130) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
