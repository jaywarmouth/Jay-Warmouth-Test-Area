#!/bin/sh
#
# Program Name	: lvskl-populyticselig_lst.sh
...
usage: lvskl-populyticselig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="LVSKLPopulytics_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "LVSKLPopulytics Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
