#!/bin/ksh
#
# Program Name	: trrx-naa_lst.sh
# Description	: Moves files and creates log listing of TrueRx-NAA eligibility file.
...
CLIENT="tf"
FTP_DIR="/usr/lnk/wt/naa-ftp/TRX/ToPDMI"
...
set_filename()
{
	ELIG_FILE="TRX-NAA-Elig-${INPUT_DATE}.txt"
	PGP_FILE="TRX-NAA-Elig-${INPUT_DATE}.txt.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-NAA-1173 Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
