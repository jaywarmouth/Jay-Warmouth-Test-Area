#!/bin/ksh
#
# Program Name	: daily_meritain.sh
# Description	: Procedure to setup claims file for TrueRx (130-1122,1123,2207)
#		  Command Line Arguments:
# Author	: Linda S. Jefferis
# Date		: 05/23/2011
# Modifications : 12/28/2012 - Changes for running on Production system
#		: 05/12/2014 - TT #10063-1 - transfer method change
#
# Variables Used:
...
set_filenames()
{
	CLM_FILE="trx_claims_daily_${DATE}.txt"
}
