#!/bin/sh
#
# Program Name	: evo-bsftelig_lst.sh
# Description	: Moves files and creates log listing of EVO-BSFT eligibility file.
...
FILE_PATH="EVO/ACRISURE/INBOUND/BSFT/Elig"
...
usage: evo-bsftelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOBSFT_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-BSFT (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
