#!/bin/ksh
#
# Program Name	: cla55_rbextract_mweek.sh
# Description	: Runs procedure to do an extract on the CLAIM55MAS.mweek file
...
usage: cla55_rbextract_mweek.sh 
...
cd ${FLEX}
echo "--> Extracting ${EXTRACT_FILE} - cla55rb3.cs"
date
cla55rb3.cs
