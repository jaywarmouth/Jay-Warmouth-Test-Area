#!/bin/sh
#
# Program Name	: evo-mbenelig_lst.sh
# Description	: Moves files and creates log listing of EVO-MBEN eligibility file.
...
FILE_PATH="EVO/MBEN/INBOUND/Elig"
...
usage: evo-mbenelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOMBEN_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-MBEN (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
