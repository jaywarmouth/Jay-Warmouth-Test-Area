#!/bin/sh
#
# Program Name	: evo-basuaccum_lst.sh
# Description	: Moves files and creates log listing of EVO-ALLI accum file.
...
FILE_PATH="EVO/BASU/INBOUND/Accum"
...
usage: evo-BASUaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="EVOBASU_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-BASU (Sys0213) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
