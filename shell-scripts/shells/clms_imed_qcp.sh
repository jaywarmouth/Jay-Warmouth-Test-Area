#!/bin/ksh
#
# Program Name	: clms_imed_qcp.sh
# Description	: Procedure to setup claims file for Informed for sys71
#		  Command Line Arguments:
#		  -p <mmddccyy>  P/E date
# Author	: Linda S. Jefferis
# Date		: 05/21/2004
# Modifications : 12/08/2004 - Changed name of LOG_FILE  (LSJ) 
...
TMP_LOC="/tmp"
TAPE_FILE="???CL130-P-QCP"
LOG_FILE="???CL130-P-QCPTEXT"
ZIP_PROG="/usr/bin/zip"
MAIL_PROG="/bin/mail"
MAIL_TO="kgray@informed-llc.com katieal-banna@informed-llc.com mattposko@informed-llc.com christopherandrews@informed-llc.com adamsaad@informed-llc.com"
...
usage: clms_imed_qcp.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="imed_qcp${MON}${DAY}.txt"
	ZIP_FILE="imed_qcp${MON}${DAY}.zip"
	NEW_LOG="totals.txt"
}
