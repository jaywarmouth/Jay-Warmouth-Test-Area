#!/bin/ksh
#
# Program Name	: clms_lash_ltib.sh
# Description	: Procedure to setup claims file for LASH-TIBOTEC
...
usage: clms_lash_ltib.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="ltib-bimon${MON}${DAY}.txt"
}
