#!/bin/ksh
#
# Program Name	: claim96conv-sat.sh
...
usage: claim96conv-sat.sh [-a all|dir|16|40|dmr|clm] -d [yymmdd|yymmdd.<sys-name>] -p [<path>] -u [########]
...
#
# Submit claim96conv-sat
submit_claim96conv-sat()
{
       case ${AUDIT} in
         "dir")
	    ...
	    echo "AUDIT20MAS=$AUDIT20MAS"
            runcobol ${OBJ_DIR}/claim96conv-sat -s ${SW} 
