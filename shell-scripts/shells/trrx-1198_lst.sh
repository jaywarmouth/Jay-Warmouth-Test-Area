#!/bin/sh
#
# Program Name	: trrx-1198_lst.sh
#		  Command Line Arguments:
#		  -d <ccyymmdd> - date included in file name sent
# Description	: Moves and creates listing of the TRRX-1198 eligibility file
# Author	: Linda S. Jefferis
# Date		: 02/20/2013
# Modifications : 03/03/2014 - changed trx-00 to trx-04
#
# Variables Used:
...
SYS_DIR="sys0130"
INPUT_DATE="null"
REMOTE_DIR="/usr/lnk/wt/trx-04/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: trrx-1198_lst.sh -d <ccyymmdd>
...
set_filename()
{
        ELIG_FILE="WBHCP_elig_${INPUT_DATE}.csv"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX-WBHCP (1198) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
