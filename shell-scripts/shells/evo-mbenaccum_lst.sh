#!/bin/sh
#
# Program Name	: evo-mbenaccum_lst.sh
...
FILE_PATH="EVO/MBEN/INBOUND/Accum"
...
usage: evo-mbenaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="EVOMBEN_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-MBEN (Sys0218) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
