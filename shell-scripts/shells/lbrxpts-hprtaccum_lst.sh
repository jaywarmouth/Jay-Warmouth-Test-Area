#!/bin/sh
#
# Program Name	: lbrxpts-hprtaccum_lst.sh
# Description	: Moves files and creates log listing of LBRX-HealthPartners accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/LBRXPTSHPRT/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: lbrxpts-hprtaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="LBRX_PTSHPRT_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "LBRX-PTSHealthPartners Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
