#!/bin/ksh
#
# Program Name	: clms_tsc_allied.sh
# Description	: Procedure to setup claims file for TrueScripts(sys0163)-Allied
...
TMP_LOC="/tmp"
TAPE_FILE="???CL109D0-W-TALL"
LOG_FILE="???CL109D0-W-TALLTEXT"
...
usage: clms_tsc_allied.sh -p <p/e date>
...
set_filenames()
{
	CLM_FILE="Weeklyclms-TSC-${PE_DATE}.txt"
}
...
copy_files()
{
	...
	then
	   ...
	   cat ${FILE_LOC}/${LOG_FILE} | ${MAIL_PROG} -s "TrueScripts-Allied Weekly Claims File Notification" -c ${MAIL_CC} ${MAIL_TO}
	else
