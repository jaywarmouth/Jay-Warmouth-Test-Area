#!/bin/sh
#
# Program Name	: abc-1084_lst.sh
# Description	: Prepares Ssponsor 1084 eligibility file sent from UHC for Benefits and processing
...
usage: abc-1084_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="PDMIExecutive834out_${INPUT_DATE}_??????.dat"
	PGP_FILE="PDMIExecutive834out_${INPUT_DATE}_??????.dat.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX - Executive Management Services (SPO1084) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
