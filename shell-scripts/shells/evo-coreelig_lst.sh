#!/bin/sh
#
# Program Name	: evo-coreelig_lst.sh
# Description	: Moves files and creates log listing of EVO-CORE eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on file sent.
# Modifcations	: 2/17/2023 - Updated CLEINT Variable to ep from at (DME)
#
# Variables Used:
INPUT_DATE="null"
...
CLIENT="ep"
FTP_DIR="/usr/lnk/wt/oper-wt/elig/EVOCORE/ToPDMI"
...
usage: evo-coreelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	PGP_FILE="EVOCORE_elig_${INPUT_DATE}.edi.pgp"
	ELIG_FILE="EVOCORE_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
	echo "EVO-CORE (Sys0213) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
