#!/bin/sh
#
# Program Name	: tr_tepflexlisting.sh
# Description	:
# Modifications : 12/26/2022 - TT22475-17; new DEST_LOC 
#
# Variables Used:
...
DEST_LOC=/usr/lnk/wt/tscempdaily-wt
...
case $FTYPE 
in
     1) RPT_NAME="TEP_SPECIALTY_CLAIMS"
	tr_file
	;;
     2) RPT_NAME="TEP_BRANDCARE_CLAIMS"
	tr_file
	;;
esac
