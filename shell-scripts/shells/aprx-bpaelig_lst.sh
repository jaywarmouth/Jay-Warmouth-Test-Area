#!/bin/sh
#
# Program Name	: aprx-bpaelig_lst.sh
# Description	: Moves files and creates log listing of APRX-BPA eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/APRXBPA/ToPDMI"
...
usage: aprx-bpaelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXBPA_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-BPA Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
