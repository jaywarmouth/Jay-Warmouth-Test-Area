#!/bin/ksh
#
# Program Name	: mbi-agmc_lst.sh
# Description	: Creates log listing of MBI-AGMC Eligibility file.
...
usage: mbi-agmc_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="80-${INPUT_DATE}.pgp"
	ELIG_FILE="80-${INPUT_DATE}.exp"
}
...
create_listing()
{
	LOG_NAME=mbi-agmc${DATE}.log
        cd ${ELIG_DIR}
        echo "MBI-AGMC Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
