...
#		  -r	Rerun Flag (to skip rerun of rttrl01.sh process)
...
WT_DIR="s3://ga-internal-transfers-dev"
...
cat ${LOG} | ${MAIL_PROG} -s "Daily RealTime Claims TEST GoAnywhere Process" ${MAIL_TO}
