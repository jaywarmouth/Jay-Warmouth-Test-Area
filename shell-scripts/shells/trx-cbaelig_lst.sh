#!/bin/ksh
#
# Program Name	: trx-cbaelig_lst.sh
# Description	: Moves files and creates log listing of TRX-CBA eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/TRXCBA/ToPDMI"
...
usage: trx-cbaelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="TRXCBA_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-CBA Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
