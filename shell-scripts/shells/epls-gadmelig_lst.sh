#!/bin/sh
#
# Program Name	: epls-gadmelig_lst.sh
# Description	: Moves files and creates log listing of EPLS-GADM eligibility file.
...
FILE_PATH="EVO/GADM/INBOUND/Elig"
...
usage: epls-gadmelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EPLSGADM_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EPLS-GADM (Sys0213) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
