#!/bin/ksh
#
# Program Name	: pnps-0566_lst.sh
# Description	: Creates log listing of PNPS/BAS eligibility file.
...
usage: pnps-0566_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="BAS-${INPUT_DATE}.txt.pgp"
	ELIG_FILE="BAS-${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=pnps-0566-${DATE}.log
        cd ${ELIG_DIR}
        echo "PNPS-BAS (spo0566) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
