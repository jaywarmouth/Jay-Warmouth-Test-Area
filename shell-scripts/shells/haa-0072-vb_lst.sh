#!/bin/ksh
#
# Program Name	: haa-0072-vb_lst.sh
#		  Command Line Arguments:
#		  -d <mmddyy> - date on elig. file sent
# Description	: Moves and creates listing of the HAA Vanbreda groups under sys0072 eligibility files
...
usage: haa-0072_lst.sh -d <mmddyy>
...
set_filename()
{
	ELIG_FILE="VANBREDA${INPUT_DATE}.csv"
}
...
create_listing()
{
        LOG_NAME=haa-0072-vb-${DATE}.log
        cd ${ELIG_DIR}
        echo "HAA-Vanbreda (sys0072) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
