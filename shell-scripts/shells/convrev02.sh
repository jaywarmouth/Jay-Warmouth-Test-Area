#!/bin/ksh
#
# Program Name	: convrev02.sh
# Description	: Updates Y2K audit files to NON-Y2K REVER00MAS file.
...
usage: convrev02.sh [-a all|dir|env|ndc|dmr|clm] -d [yymmdd] -p [<path>]
