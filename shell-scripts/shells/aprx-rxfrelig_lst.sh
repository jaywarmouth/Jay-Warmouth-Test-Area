#!/bin/sh
#
# Program Name	: aprx-rxfrelig_lst.sh
# Description	: Moves files and creates log listing of APRX-RXFR eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/APRXRXFR/ToPDMI"
...
usage: aprx-rxfrelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXRXFR_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-RXFR Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
