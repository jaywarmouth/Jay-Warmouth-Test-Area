#!/bin/sh
#
# Program Name	: evo-shpaccum_lst.sh
# Description	: Moves files and creates log listing of 0EVO-THP accum file.
...
FILE_PATH="EVO/THP/INBOUND/Accum"
...
usage: evo-thpaccum_lst.sh [-d <ccyymmdd>]
...
# Set Filenames
set_filename()
{	ACCUM_FILE="EVOTHP_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-THP (Sys0218) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
