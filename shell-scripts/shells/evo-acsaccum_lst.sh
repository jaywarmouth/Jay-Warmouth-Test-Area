#!/bin/sh
#
# Program Name	: evo-acsaccum_lst.sh
# Description	: Moves files and creates log listing of EVO-ACS accum file.
...
FILE_PATH="EVO/ACS/INBOUND/Accum"
...
usage: evo-acsaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="EVOACS_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-ACS (Sys0218) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
