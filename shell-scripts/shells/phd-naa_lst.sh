#!/bin/ksh
#
# Program Name	: phd-naa_lst.sh
# Description	: Moves files and creates log listing of PHD-NAA eligibility file (sys0169).
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on file sent.
# Author	: Linda S. Jefferis
# Date		: 08/14/2014
# Modifications : 12/05/2014 - For 2015 update FTP_DIR and naming conventions (TT 12201-3).
#
#
#
# Variables Used:
...
CLIENT="pd"
FTP_DIR="/usr/lnk/wt/naa-ftp/PHD/ToPDMI"
...
usage: phd-naa_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="PHD-NAA-Elig-${INPUT_DATE}.txt"
	PGP_FILE="PHD-NAA-Elig-${INPUT_DATE}.txt.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "PHD-NAA (sys0169) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
