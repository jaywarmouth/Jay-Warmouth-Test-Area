#!/bin/sh
#
# Program Name	: abc-1139_lst.sh
# Description	: Prepares eligibility file sent from UHC for Benefits and processing
...
usage: abc-1139_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="PDMIAllison834out_${INPUT_DATE}_??????.dat"
	PGP_FILE="PDMIAllison834out_${INPUT_DATE}_??????.dat.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX - Allison (SPO1139) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
