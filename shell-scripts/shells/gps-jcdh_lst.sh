#!/bin/ksh
#
# Program Name	: gps-jcdh_lst.sh
# Description	: Creates log listing of GPS/JCDH eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on elig. file sent.
# Author	: Linda S. Jefferis
# Date		: 04/11/2008
# Modifications : 07/01/2014 - add logci and variables to run decrypt-file.sh (TT:10901-1)(DME)
#
# Variables Used:
...
CLIENT="jc"
FTP_DIR="/usr/lnk/wt/jcdh-ftp/topdm"
...
usage: gps-jcdh_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="jcdhelig${INPUT_DATE}.gpg"
	ELIG_FILE="jcdhelig${INPUT_DATE}"
}
...
create_listing()
{
	LOG_NAME=gps-jcdh${DATE}.log
        cd ${ELIG_DIR}
        echo "GPS/JCDH(spo0522) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
