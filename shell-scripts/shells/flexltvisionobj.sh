...
do
	...
	do
		echo "$file to $sys"
		ssh -q $sys "test -e ${REOTE_FLEX_DIR}/obj/$file"
		FILESTAT=$?
		case $FLG in
		   "test")
			...
			;;
		   "prod")
			ssh uattrans20 scp -q ${REMOTE_FLEX_DIR}/obj/$file $sys:${REMOTE_FLEX_DIR}/obj
			;;
		esac
                if test $? -ne 0
                then
                   ...
                   then
                        case $sys in
                          "testprod12")
                                ssh -q testprod12 "chmod 664 ${REMOTE_FLEX_DIR}/obj/$file; chgrp default ${REMOTE_FLEX_DIR}/obj/$file"
                                ;;
                           *)
...
#                then
#                        scp -q uattrans20:${REMOTE_FLEX_DIR}/obj/$file ${FLEX_DIR}/obj
#                else
#                        scp -q uattrans20:${REMOTE_FLEX_DIR}/obj/$file ${FLEX_DIR}/obj
...
#                then
#                        scp -q uattrans20:${REMOTE_FLEX_DIR}/obj/$file ${ROBINFLEXTEST}/obj
#                else
#                        scp -q uattrans20:${REMOTE_FLEX_DIR}/obj/$file ${ROBINFLEXTEST}/obj
...
#                fi
               ...
               then
                       scp -q uattrans20:${REMOTE_FLEX_DIR}/obj/$file ${ROBINFLEXDEVTEST}/obj
               else
                       scp -q uattrans20:${REMOTE_FLEX_DIR}/obj/$file ${ROBINFLEXDEVTEST}/obj
