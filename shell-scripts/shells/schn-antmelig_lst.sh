#!/bin/ksh
#
# Program Name	: schn-antmelig_lst.sh
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/SCHNANTM/ToPDMI"
...
usage: schn-antmelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="SCHNANTM_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "Schnucks-Anthem(121) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
