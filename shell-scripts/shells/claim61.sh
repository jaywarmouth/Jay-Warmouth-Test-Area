#!/bin/ksh
#
# Program Name	: claim61.sh
# Description   : Suspended Claims Report by Group/Sponser 
...
# Submit claim61 program
submit_claim61()
{
   if [ ${SKIP_SORT} = 1 ]
     then
        runcobol ${OBJ_DIR}/claim61 -s 1
     else
        runcobol ${OBJ_DIR}/claim61 -s 0
   fi
}
...
echo Suspended Claims Report by Group/Sponser
date
echo
