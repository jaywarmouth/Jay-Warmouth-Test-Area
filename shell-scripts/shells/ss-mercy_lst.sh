...
usage: ss-mercy_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="NGS_23002_${INPUT_DATE}"
	PGP_FILE="NGS_23002_${INPUT_DATE}.pgp"
}
...
create_listing()
{
        LOG_NAME=${CLIENT_ID}e-spo0527-${DATE}.log
        cd ${ELIG_DIR}
        echo "ScriptSense-Mercy Memorial/SPO0527 Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
