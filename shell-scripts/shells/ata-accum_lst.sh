#!/bin/ksh
#
# Program Name	: ata-accum_lst.sh
#		  Command Line Arguments:
#		  -d <ccyymmdd> - date on elig. file sent
# Description	: Moves and creates listing of the QCP-ATA(sys71/spo0603) accumulator file
# Author	: Linda S. Jefferis
# Date		: 01/22/2013
# Modifcations  : 06/30/2014 - add logic and variables to run decrypt_file.sh (TT:10901-1)(DME)
#
#
# Variables Used:
...
usage: ata-accum_lst.sh -d <ccyymmdd>
...
set_filename()
{
	PGP_FILE="ATAAccumulator${INPUT_DATE}.pgp"
	ACCUM_FILE="ATAAccumulator${INPUT_DATE}"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "QCP-ATA(sys71/spo0603) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
