#!/bin/ksh
#
# Program Name	: abc-1393elig_lst.sh
# Description	: Moves files and creates log listing of ABC-75/1393 eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/wnc-ftps/ToPDMI"
REMOTE_SYS="husk"
...
usage: abc-1393elig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="ABCWellnessConnect_elig_${INPUT_DATE}.csv"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "ABC-75/1393 Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
