#!/bin/ksh
#
# Program Name	: psg-1245phys_lst.sh
# Description	: Moves files and creates log listing of PSG-1245 physician file.
...
usage: psg-1245phys_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	PHYS_FILE="PSG-Cone-phys-${INPUT_DATE}.TXT"
	PHYS_PGP_FILE="PSG-Cone-phys-${INPUT_DATE}.TXT.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "PSG-1245 Physician Files" > ${ELIG_LOG}/${LOG_NAME}
