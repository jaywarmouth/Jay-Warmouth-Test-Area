#!/bin/sh
#
# Program Name	: aprx-loomaccum_lst.sh
# Description	: Moves files and creates log listing of APRX-LOOM accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/APRXLOOM/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: aprx-loomaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="APRXLOOM_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-LOOM Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
