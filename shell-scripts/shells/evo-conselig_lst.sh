#!/bin/sh
#
# Program Name	: evo-conselig_lst.sh
# Description	: Moves files and creates log listing of EVO-CONS eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmddhhmmss> - date on file sent.
# Author	: Linda Jefferis
#		
# Modificaftions: 08/28/2025 - adding coding to pull files from s3 location (DME)
#
#
# Variables Used:
INPUT_DATE="null"
...
FILE_PATH="EVO/CONS/INBOUND/Elig"
...
usage: evo-conselig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOCONS_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-CONS (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
