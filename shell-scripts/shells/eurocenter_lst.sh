#!/bin/ksh
#
# Program Name	: eurocenter_lst.sh
#		  Command Line Arguments:
#		  -d <mmddccyy> - date on elig. file sent
# Description	: Moves and creates listing of the EuroCenter (sys90/spo0498) eligibility file
...
usage: eurocenter_lst.sh -d <mmddccyy>
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EuroCenter (sys0090/spo0498) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
