...
usage: abc-1098_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="PDMICardon834out_${INPUT_DATE}_??????.dat"
	PGP_FILE="PDMICardon834out_${INPUT_DATE}_??????.dat.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX - Cardon (SPO1098) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
