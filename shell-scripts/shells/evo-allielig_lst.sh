#!/bin/sh
#
# Program Name	: evo-allielig_lst.sh
# Description	: Moves files and creates log listing of EVO-ALLI eligibility file.
...
FILE_PATH="EVO/ALLI/INBOUND/Elig"
...
usage: evo-allielig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOALLI_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-ALLI (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
