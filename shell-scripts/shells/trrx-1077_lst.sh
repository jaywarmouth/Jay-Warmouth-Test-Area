#!/bin/sh
#
# Program Name	: abc-1077_lst.sh
# Description	: Prepares Centaur eligibility file sent from UHC for Benefits and processing
...
usage: abc-1077_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="PDMICentaur834out_${INPUT_DATE}_??????.dat"
	PGP_FILE="PDMICentaur834out_${INPUT_DATE}_??????.dat.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX - Centaur (SPO1077) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
