#!/bin/ksh
#
# Program Name	: psg-1206_lst.sh
# Description	: Moves files and creates log listing of PSG-1206 eligibility file.
...
usage: psg-1206_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="PSG-Michigan-elig-${INPUT_DATE}.TXT"
	PGP_FILE="PSG-Michigan-elig-${INPUT_DATE}.TXT.pgp"
...
get_file()
{
        #decrypt and mv eligibility file
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "PSG-1206 Eligibility/Physician Files" > ${ELIG_LOG}/${LOG_NAME}
        echo "---------------------------------------------------" >> ${ELIG_LOG}/${LOG_NAME}
        echo "" >> ${ELIG_LOG}/${LOG_NAME}
        ls -l ${CLIENT}[e,p]${DATE} >> ${ELIG_LOG}/${LOG_NAME}
