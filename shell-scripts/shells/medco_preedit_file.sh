...
#
#
# Program Name	: medco_preedit_file.sh
# Description	: Procedure to decrypt and upload Medco pre-edit file To internal Transfers.
#		  Command Line Arguments:
#		  -d <ccyymmdd> - alternate date for input file; by default uses current date.
# Author	: Dawn M. Engler
# Date		: 01/19/2015
# Modifications : 03/17/2015 - Changes to fix process failures.
#		: 12/14/2015 - add warehouse File directory and email notifcation. (TT:12309-17 DME)
#		: 12/21/2015 - removing previous changes. Not file warehouse needs.
#		: 10/16/2018 - add dhomoly/jcolatruglio WT distribution
...
OUT_DIR_3=/usr/lnk/wt/rpavelick
OUT_DIR_4=/usr/lnk/wt/dhomoly
OUT_DIR_5=/usr/lnk/wt/jcolatruglio
OUT_DIR_6=/usr/lnk/wt/cbruss
MAIL_PROG="/usr/bin/mutt"
MAIL_SUBJ="Medco Pre-edit File"
MAIL_TO="tyoung@pdmi.com pvoytilla@pdmi.com rpavelick@pdmi.com jcolatruglio@pdmi.com dhomoly@pdmi.com cbruss@pdmi.com"
...
get_file()
{
OUT_FILE=`echo ${PGP_FILE} | cut -c1-37` 
...
for PGP_FILE in $(ls -1 PDMI_Preedit_2077_????????.*.txt.pgp);
do
