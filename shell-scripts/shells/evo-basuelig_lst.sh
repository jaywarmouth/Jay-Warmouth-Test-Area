#!/bin/sh
#
# Program Name	: evo-basuelig_lst.sh
# Description	: Moves files and creates log listing of EVO-BASU eligibility file.
...
FILE_PATH="EVO/BASU/INBOUND/Elig"
...
usage: evo-basuelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOBASU_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-BSEN (Sys0213) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
