#!/bin/sh
#
# Program Name	: evo-consaccum_lst.sh
# Description	: Moves files and creates log listing of EVO-CONS accum file.
...
FILE_PATH="EVO/CONS/INBOUND/Accum"
...
usage: evo-consaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="EVOCONS_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-CONS (Sys0218) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
