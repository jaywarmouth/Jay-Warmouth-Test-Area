#!/bin/ksh
#
# Program Name	: lbrx-1293_lst.sh
# Description	: Creates log listing of HomeTwon (159) eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/aux-ftps/ToPDMI"
...
usage: lbrx-1293_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="Meskwaki_elig_${INPUT_DATE}.csv"
}
...
create_listing()
{
	LOG_NAME=${CLIENT}e-${DATE}.log
        cd ${ELIG_DIR}
        echo "LBRX-Meskwaki (160-1292) Files" > ${ELIG_LOG}/${LOG_NAME}
