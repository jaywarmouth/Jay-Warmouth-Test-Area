#!/bin/ksh
#
# Program Name	: trx-gpaelig.sh
# Description	: Moves files and creates log listing of TRX-GPA eligibility file.
...
usage: trx-gpaelig.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="TRXGPA_elig_${INPUT_DATE}.txt"
	PGP_FILE="TRXGPA_elig_${INPUT_DATE}.txt.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TrueRx-GPA Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
