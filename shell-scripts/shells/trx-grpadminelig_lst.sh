#!/bin/ksh
#
# Program Name	: trx-grpadminelig_lst.sh
# Description	: Moves files and creates log listing of TRX-GroupAdministrators eligibility file.
...
usage: trx-grpadminelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="TRXGRPADMIN_elig_${INPUT_DATE}.dat"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRX-GroupAdministrators (0130) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
