#!/bin/ksh
#
# Program Name	: clms_medben_55493.sh
# Description	: Procedure to setup claims file for Grp #55493 under MedBen
...
DEST_LOC="firefly:/usr/lnk/wt/haw-wt"
TMP_LOC="/tmp"
TAPE_FILE="???CL109-M-D2H"
LOG_FILE="???D2HTEXT"
...
usage: clms_medben_55493.sh -p <m/e date>
...
copy_files()
{
	...
	then
	   ...
	   echo "The file, ${ZIP_FILE} for ${MON}/${YEAR}, is now available." | ${MAIL_PROG} -s "MEDBEN/D2HAWKEYE MONTHLY CLAIMS FILE NOTIFICATION" ${MAIL_TO}
	else
