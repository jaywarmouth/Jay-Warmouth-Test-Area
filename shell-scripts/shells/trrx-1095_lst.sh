#!/bin/sh
#
# Program Name	: abc-1095_lst.sh
# Description	: Prepares Cook Medical eligibility file sent from PBA for Benefits and processing
...
FTP_DIR="/usr/lnk/wt/prba-ftp/ToPDMI"
...
usage: abc-1095_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="cooktelig_${INPUT_DATE}_PDMI.txt"
	PGP_FILE="cooktelig_${INPUT_DATE}_PDMI.txt.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX - Cook Medical (SPO1095) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
