#!/bin/sh
#
# Program Name	: evo-prstelig_lst.sh
# Description	: Moves files and creates log listing of EVO-PRST eligibility file.
...
FILE_PATH="EVO/PRST/INBOUND/Elig"
...
usage: evo-prstelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOPRST_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-PRST (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
