...
set_filenames()
{
	CLM_FILE="imed${MON}${DAY}.txt"
	ZIP_FILE="imed${MON}${DAY}.zip"
	NEW_LOG="totals.txt"
}
...
copy_files()
{
	...
	then
	   ...
	   echo "The file, ${ZIP_FILE}.pgp for P/E ${PE_DATE}, is now available. Please delete the file once you have downloaded it." | ${MAIL_PROG} -s "INFORMED CLAIMS FILE NOTIFICATION" ${MAIL_TO}
	else
