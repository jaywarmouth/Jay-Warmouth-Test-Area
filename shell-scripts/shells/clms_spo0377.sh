#!/bin/ksh
#
# Program Name	: clms_spo0377.sh
# Description	: Procedure to setup claims file for sys68/spo0377 to send to UPMC
#		  Command Line Arguments:
#		  -p <mmccyy>  M/E date
# Author	: Linda S. Jefferis
# Date		: 07/19/2006
# Modifications : 05/21/2008 - Added logic for FTP using secure_transfer.sh  (LSJ) 
#
# Variables Used:
...
usage: clms_spo0377.sh -p <m/e date>
...
set_filenames()
{
	CLM_FILE="upmc_bmr${PE_DATE}.txt"
	ZIP_FILE="upmc_bmr${PE_DATE}.zip"
	NEW_LOG="totals.txt"
}
