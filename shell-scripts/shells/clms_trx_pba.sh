#!/bin/ksh
#
# Program Name	: clms_trx_pba.sh
# Description	: Procedure to setup claims file for TrueRx (130-1129,1139,1143)
...
TMP_LOC="/tmp"
TAPE_FILE="???CL111D0-W-PBA"
LOG_FILE="???CL111D0-W-PBATEXT"
...
usage: clms_trx_pba.sh -p <p/e date>
...
copy_files()
{
	...
	then
	   ...
	   cat ${FILE_LOC}/${LOG_FILE} | ${MAIL_PROG} -s "TRX-PBA WEEKLY CLAIMS FILE NOTIFICATION" -c ${MAIL_CC} ${MAIL_TO}
