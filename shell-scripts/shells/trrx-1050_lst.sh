#!/bin/ksh
#
# Program Name	: trrx_1050_lst.sh
# Description	: Creates log listing of TrueRX-Indiana Furniture eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date in file sent.
# Author	: Linda S. Jefferis
# Date		: 12/01/2010
# Modifications : 06/24/2014 - add coding and variables needed to run decrypt_file.sh (TT10901-1)(DME) 
#
...
usage: trrx_1050_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="PHP_PDMI_${INPUT_DATE}.txt.pgp"
	ELIG_FILE="PHP_PDMI_${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=trrx-1050-${DATE}.log
        cd ${ELIG_DIR}
        echo "TrueRx/Indiana Furniture (SPO1050) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
