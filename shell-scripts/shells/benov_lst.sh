#!/bin/sh
#
# Program Name	: benov_lst.sh
# Description	: Prepares eligibility file sent from Benovations (sys0102) for Benefits and processing
...
FTP_DIR="/usr/lnk/wt/aebs-ftp/in"
...
set_filenames()
{
	ELIG_FILE="834_BENOVATION_${INPUT_DATE}.TXT"
	PGP_FILE="834_BENOVATION_${INPUT_DATE}.TXT.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "Benovations (SYS-102) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
