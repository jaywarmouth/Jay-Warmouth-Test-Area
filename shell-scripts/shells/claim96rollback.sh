#!/bin/ksh
#
# Program Name	: claim96rollback.sh
...
usage: claim96rollback.sh [-a all|dir|16|40|dmr|clm] -d [ccyymmdd|ccyymmdd.<sys-name>] -p [<path>] -u [########]
...
#
# Submit claim96rollback
submit_claim96rollback()
{
       case ${AUDIT} in
         "dir")
	    ...
	    echo "AUDIT20MAS=$AUDIT20MAS"
            runcobol ${OBJ_DIR}/claim96rollback -s ${SW}
