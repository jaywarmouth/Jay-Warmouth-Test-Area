#!/bin/sh
#
# Program Name	: lvhn-popaccum_lst.sh
# Description	: Moves files and creates log listing of LVHN-Populytics (sys0162) accum file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/LVHNPopulytics/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: lvhn-popaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="LVHNPopulytics_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "LVHN-Populytics Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
