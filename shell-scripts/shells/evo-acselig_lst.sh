#!/bin/sh
#
# Program Name	: evo-acselig_lst.sh
# Description	: Moves files and creates log listing of EVO-ACS eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on file sent.
# Modifications : 08/28/2025 - Added codoing for AWS locations (DME)
#
#
# Variables Used:
INPUT_DATE="null"
...
FILE_PATH="EVO/ACS/INBOUND/Elig"
...
usage: evo-acselig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOACS_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-ACS (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
