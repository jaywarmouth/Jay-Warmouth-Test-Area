#!/bin/sh
#
# Program Name	: aprx-ubpcelig_lst.sh
# Description	: Moves files and creates log listing of APRX-UBPC eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/APRXUBPC/ToPDMI"
...
usage: aprx-ubpcelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXUBPC_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-UBPC Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
