#!/bin/ksh
#
# Program Name	: healthsmart-2363_lst.sh
# Description	: Moves files and creates log listing of SilverBackRx Health Smart eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date on file sent.
# Author	: Dawn M. Engler
# Date		: 7/14/2014
# Modification  : 07/25/2014 - added missing "-X12" suffix
#
# Variables Used:
...
CLIENT="sh"
FTP_DIR="/usr/lnk/wt/hsbs-ftp/ToPDMI"
...
usage: tsc-bas_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="LBRXHealthsmart_elig_${INPUT_DATE}.dat"
	PGP_FILE="LBRXHealthsmart_elig_${INPUT_DATE}.dat.pgp"
}
...
get_file()
{
   ...
   then
        ...
        sh ${PGP_SCRPT} ${PGP_FILE}  ${ELIG_FILE}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "SilverBack-HealthSmart(sys160) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
