#!/bin/sh
#
# Program Name	: aprx-loomelig_lst.sh
# Description	: Moves files and creates log listing of APRX-LOOM eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/APRXLOOM/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: aprx-loomelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXLOOM_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-LOOM Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
