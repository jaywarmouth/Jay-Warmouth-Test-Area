#!/bin/ksh
#
# Program Name	: haa-0585_lst.sh
#		  Command Line Arguments:
#		  -d <mmddyy> - date on elig. file sent
# Description	: Moves and creates listing of the HAA-Bristow (sys90/spo0585) eligibility file
...
usage: haa-0585_lst.sh -d <mmddyy>
...
set_filename()
{
	ELIG_FILE="BRISTOW${INPUT_DATE}.csv"
}
...
create_listing()
{
        LOG_NAME=haa-0585-${DATE}.log
        cd ${ELIG_DIR}
        echo "HAA-Bristow (spo0585) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
