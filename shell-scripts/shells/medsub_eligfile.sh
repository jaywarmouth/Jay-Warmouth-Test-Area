#!/bin/sh
#
# Program Name	: medsub_eligfile.sh
...
RPT_DIR=/usr/lnk/rpt
ARCH_DIR="/usr/lnk/tapes/MEDSUB/Archive"
...
${SHELL_DIR}/tr_medsubelig_HMS.sh

${SHELL_DIR}/tr_medsubelig_CHC.sh

rm -f ${ARCH_DIR}/PDMIELIG.*.txt

mv ${SEND_FILE} ${ARCH_DIR}
