#!/bin/ksh
#
# Program Name	: abc-1041_lst.sh
# Description	: Creates log listing of ABC-McKee eligbility file.
...
usage: abc-1041_lst.sh [-d <ccyymmdd>_<hhmmss>]
...
set_filename()
{
	ELIG_FILE="PDMI_MCKEE_ELG_${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=${CLIENT}e-${DATE}.log
        cd ${ELIG_DIR}
        echo "ABC-McKee (1041) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
