#!/bin/sh
#
# Program Name	: trx-khaelig_lst.sh
# Description	: Creates log listing of TrueRx-KHA eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/TRXKHA/ToPDMI"
SYS="sys0130"
MAIL_PROG="/bin/mail"
...
usage: trx-khaelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="TRXKHA_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
	LOG_NAME=${CLIENT}e-${DATE}.log
        cd ${ELIG_DIR}
        echo "TrueRx-KHA Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
