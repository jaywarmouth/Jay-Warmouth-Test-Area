#!/bin/sh
#
# Program Name	: aprx-robbelig_lst.sh
# Description	: Moves files and creates log listing of APRX-ROBB eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/APRXROBB/ToPDMI"
...
usage: aprx-robbelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="APRXROBB_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "APRX-ROBB Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
