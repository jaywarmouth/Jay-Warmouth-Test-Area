#!/bin/sh
#
# Program Name	: urx-imbelig_lst.sh
# Description	: Creates log listing of URX-IMB eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date in file sent.
# Author	: Linda S. Jefferis
# Date		: 10/20/2017
# Modifcations	: 08/08/2025 - added coding to Handle AWS files
#
...
FILE_PATH="URX/IMB/INBOUND/Elig"
...
usage: urx-imbelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="URXIMB_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=${CLIENT}e-${DATE}.log
        cd ${ELIG_DIR}
        echo "URX-IMB Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
