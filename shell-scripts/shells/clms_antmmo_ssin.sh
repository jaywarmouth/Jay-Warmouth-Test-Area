#!/bin/ksh
#
# Program Name	: clms_antmmo_ssin.sh
# Description	: Procedure to setup claims file for sys68/spo0367 to send to ANTMMO
...
TMP_LOC="/tmp"
TAPE_FILE="???CL109D0-M-SSIN"
LOG_FILE="???CL109D0-M-SSINTEXT"
...
usage: clms_antmmo_ssin.sh -p <m/e date>
...
set_filenames()
{
	CLM_FILE="antmmo_ssin${PE_DATE}.txt"
	ZIP_FILE="antmmo_ssin${PE_DATE}.zip"
	NEW_LOG="totals.txt"
}
