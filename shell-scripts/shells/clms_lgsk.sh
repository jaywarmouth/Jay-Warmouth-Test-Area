#!/bin/sh
#
# Program Name	: clms_lgsk.sh
# Description	: Procedure to setup claims file for LASH/GSK (sys0178)
...
TAPE_FILE="???CL111D0-T-LGSK"
LOG_FILE="???CL111D0-T-LGSKTEXT"
...
set_filenames()
{
	CLM_FILE="Refreshclms-LGSK-${PE_DATE}.txt"
}
