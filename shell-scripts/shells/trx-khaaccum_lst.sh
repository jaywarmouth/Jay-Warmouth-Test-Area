#!/bin/ksh
#
# Program Name	: trx-khaaccum_lst.sh
# Description	: Creates log listing of TrueRx-KHA Accumulator file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/accum/TRXKHA/ToPDMI"
DATE="null"
MAIL_PROG="/bin/mail"
...
usage: trx-khaaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="TRXKHA_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=${CLIENT}l-${DATE}.log
        cd ${ELIG_DIR}
        echo "TrueRx-KHA Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
