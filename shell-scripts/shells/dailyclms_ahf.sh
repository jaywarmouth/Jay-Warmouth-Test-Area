#!/bin/ksh
#
# Program Name	: dailyclms_ahf.sh
# Description	: Procedure to provide daily claims file to AHF 
...
TMP_LOC="/tmp"
TAPE_FILE="???CL111DAYD0-P-AHF"
CONV_PROG="/usr/local/bin/addlf"
REC_LEN="500"
TR_PROG="/usr/lnk/shell/secure_transfer.sh"
TR_ID="AULT27"
DATE=`date -d "yesterday 0800" +%m%d%Y`
...
set_filenames()
{
	CLM_FILE="dailyAHFclms-${DATE}.txt"
}
