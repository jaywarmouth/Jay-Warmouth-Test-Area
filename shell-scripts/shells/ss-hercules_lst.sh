#!/bin/sh
#
# Program Name	: ss-hercules_lst.sh
...
usage: ss-hercules_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="NGS_23005_${INPUT_DATE}"
	PGP_FILE="NGS_23005_${INPUT_DATE}.pgp"
}
...
create_listing()
{
        LOG_NAME=${CLIENT_ID}e-spo0608-${DATE}.log
        cd ${ELIG_DIR}
        echo "ScriptSense-Hercules Tire/SPO0608 Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
