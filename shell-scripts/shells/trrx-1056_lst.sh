#!/bin/ksh
#
# Program Name	: trrx_1056_lst.sh
# Description	: Creates log listing of TrueRX-Daviess County eligibility file.
#                 Command Line Arguments:
#                 -d <ccyymmdd> - date in file sent.
# Author	: Linda S. Jefferis
# Date		: 01/21/2011
# Modifications : 06/30/2014 - add coding and variables to run the decrypt_file.sh program.(TT:10901-1)(DME)
#		: 12/26/2014 - change file name to new file and place ToPDMI as the FTP directory. (DME)
# 
#
...
CLIENT="dc"
FTP_DIR="/usr/lnk/wt/siho-ftp/ToPDMI"
...
usage: trrx_1056_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
        PGP_FILE="TRXSIHO_elig_${INPUT_DATE}.txt.pgp"
	ELIG_FILE="TRXSIHO_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
	LOG_NAME=trrx-1056-${DATE}.log
        cd ${ELIG_DIR}
        echo "TrueRx/Daviess County (SPO1056) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
