#!/bin/sh
#
# Program Name	: ncpdp_wkly_trans.sh
...
usage: ncpdp_wkly_trans.sh -d <ccyymmdd> -t
...
set_filenames()
{
	...
	ZIP_FILE="NCPDP_v3.1_Weekly_Transaction_${FILE_DATE}.ZIP"
...
cd ${DEST_DIR}
echo "The Weekly Add/Change NCPDP files are available for processing."  > ${LOG_NAME}
echo "" >> ${LOG_NAME}
