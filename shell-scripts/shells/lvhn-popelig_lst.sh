#!/bin/sh
#
# Program Name	: lvhn-popelig_lst.sh
# Description	: Moves files and creates log listing of LVHN-Populytics (sys0162) eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/LVHNPopulytics/ToPDMI"
MAIL_PROG="/bin/mail"
...
usage: lvhn-popelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="LVHNPopulytics_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "LVHN-Populytics Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
