#!/bin/ksh
#
# Program Name	: cla55_rbextract_week.sh
# Description	: Runs procedure to do an extract on the CLAIM55MAS.week file
...
cd ${FLEX}
echo "--> Extracting ${EXTRACT_FILE} - cla55rb2_week.cs"
date
cla55rb2_week.cs
