#!/bin/sh
#
# Program Name	: abc-2203_lst.sh
# Description	: Prepares Heartland Auto eligibility file sent from UHC for Benefits and processing
...
usage: abc-2203_lst.sh -d <ccyymmdd>
...
set_filenames()
{
	ELIG_FILE="PDMIHeartlandAuto834out_${INPUT_DATE}_??????.dat"
	PGP_FILE="PDMIHeartlandAuto834out_${INPUT_DATE}_??????.dat.pgp"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "TRRX - Heartland (SPO2203) Eligibility File" > ${ELIG_LOG}/${LOG_NAME}
