#!/bin/ksh
#
# Program Name	: clms_ingenix_mckee.sh
# Description	: Procedure to setup claims file for sys75/spo01041 to send to Ingenix
#		  Command Line Arguments:
#		  -p <mmccyy>  M/E date
# Author	: Linda S. Jefferis
# Date		: 04/15/2011
# Modifications : 12/23/2011 - Changed TR_ID from INGX to UHC
#
# Variables Used:
...
TMP_LOC="/tmp"
TAPE_FILE="???CL109D0-M-MKF"
LOG_FILE="???CL109D0-M-MKFTEXT"
...
usage: clms_ingenix_mckee.sh -p <m/e date>
...
set_filenames()
{
	CLM_FILE="mckee${PE_DATE}.txt"
	ZIP_FILE="mckee${PE_DATE}.zip"
	NEW_LOG="mckee-totals.txt"
}
