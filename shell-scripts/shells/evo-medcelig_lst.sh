#!/bin/sh
#
# Program Name	: evo-medcelig_lst.sh
# Description	: Moves files and creates log listing of EVO-MEDC eligibility file.
...
FILE_PATH="EVO/MEDC/INBOUND/Elig"
...
usage: evo-medcelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOMEDC_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-MEDC (Sys0218) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
