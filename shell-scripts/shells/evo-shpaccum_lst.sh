...
# Description	: Moves files and creates log listing of EVO-SHP accum file.
...
FILE_PATH="EVO/SHP/INBOUND/Accum"
...
usage: evo-shpaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="EVOSHP_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-SHP (Sys0218) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
