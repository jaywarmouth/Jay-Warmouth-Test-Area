...
"
EQUAL="="
INDIR="/usr/lnk/wt/oper-wt/MEDSUB/HMS/ToPDMI"
DEST_LOC="/usr/lnk/wt/oper-wt/MEDSUB/HMS/In"
REJ_LOC="/usr/lnk/wt/oper-wt/MEDSUB/HMS/Rejected"
LOG="/tmp/medsub.log"
MAIL_PROG="/bin/mail"
...
echo "" >> ${LOG}
cd ${INDIR}
for file in `ls -1 PDMICLAIMS.RXDMI.TRB???.*.*.TXT`
do
...
cat ${LOG} | ${MAIL_PROG} -s "Medicaid Subrogation" ljefferis@pdmi.com
