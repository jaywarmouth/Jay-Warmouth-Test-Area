#!/bin/sh
#
# Program Name	: evo-alliaccum_lst.sh
...
FILE_PATH="EVO/ALLI/INBOUND/Accum"
...
usage: evo-alliaccum_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ACCUM_FILE="EVOALLI_accum_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-ALLI (Sys0218) Accumulator File" > ${ELIG_LOG}/${LOG_NAME}
