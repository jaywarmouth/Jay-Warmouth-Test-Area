#!/bin/sh
#
# Program Name	: rdh-redielig_lst.sh
# Description	: Moves files and creates log listing of RDH-REDI eligibility file.
...
FILE_PATH="RDH/REDI/INBOUND/Elig"
...
usage: rdh-redielig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="RDH_elig_${INPUT_DATE}.txt"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "RDH-REDI (Sys0291) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
