#!/bin/sh
#
# Program Name	: evo-jpfelig_lst.sh
# Description	: Moves files and creates log listing of EVO-JPF eligibility file.
...
REMOTE_DIR="/usr/lnk/wt/oper-wt/elig/EVOJPF/ToPDMI"
...
usage: evo-jpfelig_lst.sh [-d <ccyymmdd>]
...
set_filename()
{
	ELIG_FILE="EVOJPF_elig_${INPUT_DATE}.edi"
}
...
create_listing()
{
        ...
        cd ${ELIG_DIR}
        echo "EVO-JPF (Sys0213) Eligibility Files" > ${ELIG_LOG}/${LOG_NAME}
