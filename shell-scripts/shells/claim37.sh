#!/bin/ksh
#
# Program Name	: claim37.sh
# Description   : Adjustment Claims Report 
...
# Submit claim37 program
submit_claim37()
{
      runcobol ${OBJ_DIR}/claim37 -s ${SKIP_SORT}
}
