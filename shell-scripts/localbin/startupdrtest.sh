#!/bin/sh
#
# Program Name	: startupdrtest.sh
# Description	: Startup script for system excluding processes 
# for Zerto failover test
...
echo "webclaims dameons NOT started for DR test."
...
echo "ELGRT02 NOT STARTED for DR test"
...
echo "Formulary NOT STARTED for DR test"
...
${PDM_PATH}/queue2post.sh ${PDM_CONFIG}/rtc/queue2post_app101p1.cfg ${PDM_LOG}/rtc/queue2post_app101p1 &
${PDM_PATH}/queue2post.sh ${PDM_CONFIG}/rtc/queue2post_app101p2.cfg ${PDM_LOG}/rtc/queue2post_app101p2 &
${PDM_PATH}/queue2post.sh ${PDM_CONFIG}/rtc/queue2post_app101p3.cfg ${PDM_LOG}/rtc/queue2post_app101p3 &

#${PDM_PATH}/queue2post.sh ${PDM_CONFIG}/rtc/queue2post_app201p1.cfg ${PDM_LOG}/rtc/queue2post_app201p1 &
#${PDM_PATH}/queue2post.sh ${PDM_CONFIG}/rtc/queue2post_app201p2.cfg ${PDM_LOG}/rtc/queue2post_app201p2 &
#${PDM_PATH}/queue2post.sh ${PDM_CONFIG}/rtc/queue2post_app201p3.cfg ${PDM_LOG}/rtc/queue2post_app101p3 &
...
echo "RxHUB COBOL NOT STARTED for DR test"
...
echo "RTCJSON NOT STARTED for DR test"
